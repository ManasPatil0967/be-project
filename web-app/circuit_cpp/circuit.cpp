...
void AgeAndIDVerification_6_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void AgeAndIDVerification_6_run(uint ctx_index,Circom_CalcWit* ctx);
...
// load src
Fr_shr(&expaux[1],&signalValues[mySignalStart + 9],&lvar[3]); // line circom 11
Fr_band(&expaux[0],&expaux[1],&circuitConstants[2]); // line circom 11
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_sub(&expaux[2],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 0)],&circuitConstants[2]); // line circom 12
Fr_mul(&expaux[1],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 0)],&expaux[2]); // line circom 12
{{
...
PFrElement aux_dest = &lvar[1];
// load src
Fr_mul(&expaux[1],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 0)],&lvar[2]); // line circom 13
Fr_add(&expaux[0],&lvar[1],&expaux[1]); // line circom 13
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[2];
// load src
Fr_add(&expaux[0],&lvar[2],&lvar[2]); // line circom 14
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
{{
Fr_eq(&expaux[0],&lvar[1],&signalValues[mySignalStart + 9]); // line circom 17
}}
...
if (!Fr_isTrue(&circuitConstants[2])) std::cout << "Failed assert in template/function " << myTemplateName << " line 21. " <<  "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
...
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 1],&circuitConstants[4]); // line circom 27
Fr_sub(&expaux[0],&expaux[1],&signalValues[mySignalStart + 2]); // line circom 27
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
...
Fr_sub(&expaux[0],&circuitConstants[2],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 8]); // line circom 29
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
for (uint i = 0; i < 1; i++){
...
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 1],&circuitConstants[2]); // line circom 39
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 0)];
// load src
Fr_shr(&expaux[1],&signalValues[mySignalStart + 5],&lvar[3]); // line circom 11
Fr_band(&expaux[0],&expaux[1],&circuitConstants[2]); // line circom 11
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
...
{{
Fr_eq(&expaux[0],&lvar[1],&signalValues[mySignalStart + 5]); // line circom 17
}}
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template/function " << myTemplateName << " line 17. " <<  "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
for (uint i = 0; i < 0; i++){
...
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 1],&circuitConstants[7]); // line circom 27
Fr_sub(&expaux[0],&expaux[1],&signalValues[mySignalStart + 2]); // line circom 27
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
...
// load src
cmp_index_ref_load = 0;
Fr_sub(&expaux[0],&circuitConstants[2],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 4]); // line circom 29
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
for (uint i = 0; i < 1; i++){
...
ctx->componentMemory[coffset].templateName = "AgeAndIDVerification";
ctx->componentMemory[coffset].signalStart = soffset;
...
Fr_sub(&expaux[2],&signalValues[mySignalStart + 0],&circuitConstants[2]); // line circom 61
Fr_mul(&expaux[1],&signalValues[mySignalStart + 0],&expaux[2]); // line circom 61
{{
Fr_eq(&expaux[0],&expaux[1],&circuitConstants[1]); // line circom 61
}}
...
assert(Fr_isTrue(&expaux[0]));
Fr_sub(&expaux[2],&signalValues[mySignalStart + 1],&circuitConstants[2]); // line circom 62
Fr_mul(&expaux[1],&signalValues[mySignalStart + 1],&expaux[2]); // line circom 62
{{
...
AgeAndIDVerification_6_create(1,0,ctx,"main",0);
AgeAndIDVerification_6_run(0,ctx);
}
