...
/usr/local/ssl/bin/openssl s_server -cert /home/kyber/kyber_cert/dilithium3_srv.crt -key /home/kyber/kyber_cert/dilithium3_srv.key -www -tls1_3 -groups kyber768:frodo640shake -debug -security_debug_verbose -provider oqsprovider
